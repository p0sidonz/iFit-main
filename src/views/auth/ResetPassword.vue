  ...
  methods: {
    ...
    async changePW() {
      try {
        ...
        console.log(data);
        if (data.data.forgotChangePassword.ok) {
          this.$toast({
            component: ToastificationContent,
            props: {
              title: "Success",
              icon: "EditIcon",
              variant: "success",
              text: "Password changed successfully!, Please try to login now!",
            },
          });
        }
        if (!data.data.forgotChangePassword.ok) {
          this.$toast({
            ...
            props: {
              ...
              icon: "EditIcon",
              variant: "danger",
              text: "Token expired, Please request a new password reset link",
            },
          });
        }
      } catch (error) {
